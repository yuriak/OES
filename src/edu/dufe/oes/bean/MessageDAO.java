...
public class MessageDAO extends BaseHibernateDAO {
	...
	public static final String SENDER_DELETE_STATUS = "senderDeleteStatus";
	public static final String RECEIVER_DELETE_STATUS = "receiverDeleteStatus";
	...
	public List findByExample(Message instance) {
		...
		try {
			List results = getSession()
					.createCriteria("edu.dufe.oes.bean.Message")
	...
	public List findByOpenStatus(Object openStatus) {
		return findByProperty(OPEN_STATUS, openStatus);
	}

	public List findBySenderDeleteStatus(Object senderDeleteStatus) {
		return findByProperty(SENDER_DELETE_STATUS, senderDeleteStatus);
	}

	public List findByReceiverDeleteStatus(Object receiverDeleteStatus) {
		return findByProperty(RECEIVER_DELETE_STATUS, receiverDeleteStatus);
	}
