...
public class CourseDAO extends BaseHibernateDAO {
	...
	public List findByExample(Course instance) {
		...
		try {
			List results = getSession()
					.createCriteria("edu.dufe.oes.bean.Course")
	...
	public List findByCourseOrder(Object courseOrder) {
		return findByProperty(COURSE_ORDER, courseOrder);
	}
