...
public class NoticeDAO extends BaseHibernateDAO {
	...
	public List findByExample(Notice instance) {
		...
		try {
			List results = getSession()
					.createCriteria("edu.dufe.oes.bean.Notice")
	...
	public List findByEmergencyLevel(Object emergencyLevel) {
		return findByProperty(EMERGENCY_LEVEL, emergencyLevel);
	}
